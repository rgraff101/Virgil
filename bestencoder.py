...
if __name__ == "__main__":
    ...
    rm.reset_encoder()
    # 1 TURN 90
    target_distance = WHEEL_SEPARATION / 2 * pi / 2.1  # m
    ...
    rm.reset_encoder()
    # 2 TURN 90
    target_distance = WHEEL_SEPARATION / 2 * pi / 2.3  # m
    target_counts = target_distance / (WHEEL_RADIUS * 2 * pi) * GEAR_RATIO * CPR - 256
    print(f"target encoder counts: {target_counts}")
    while lm.encoder_counts < target_counts and rm.encoder_counts < target_counts:
        if lm.encoder_counts - rm.encoder_counts > 32:
    ...
    rm.reset_encoder()
    # 4 TURN 90
    target_distance = WHEEL_SEPARATION / 2 * pi / 1.8  # m
    target_counts = target_distance / (WHEEL_RADIUS * 2 * pi) * GEAR_RATIO * CPR - 256
    print(f"target encoder counts: {target_counts}")
    while lm.encoder_counts < target_counts and rm.encoder_counts < target_counts:
        if lm.encoder_counts - rm.encoder_counts > 32:
    ...
    rm.reset_encoder()
    # 5  TURN 90
    target_distance = WHEEL_SEPARATION / 2 * pi / 1.9  # m
    target_counts = target_distance / (WHEEL_RADIUS * 2 * pi) * GEAR_RATIO * CPR - 256
    print(f"target encoder counts: {target_counts}")
    while lm.encoder_counts < target_counts and rm.encoder_counts < target_counts:
        if lm.encoder_counts - rm.encoder_counts > 32:
    ...
    rm.reset_encoder()
    # 3 TURN 90
    target_distance = WHEEL_SEPARATION / 2 * pi / 2.2  # m
    target_counts = target_distance / (WHEEL_RADIUS * 2 * pi) * GEAR_RATIO * CPR - 256
    print(f"target encoder counts: {target_counts}")
    while lm.encoder_counts < target_counts and rm.encoder_counts < target_counts:
        if lm.encoder_counts - rm.encoder_counts > 32:
